...
public class TrenteDeuxBits {
	...
	public TrenteDeuxBits(){
		...
		octS[1]  = JOptionPane.showInputDialog(null, "Entrez le deuxième octet");
		octS[2]  = JOptionPane.showInputDialog(null, "Entrez le troisième octet");
		octS[3]  = JOptionPane.showInputDialog(null, "Entrez le quatrième octet");
		int oct[] = new int[4];
